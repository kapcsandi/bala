...
#      Season.find_or_create_by_name_and_start_and_end(:name => 'post_saison', :start => '2010-08-28', :end => '2010-12-31')
      User.create(:username => 'admin1', :email => 'renata.gerhat@1xferienhaus.de', :password => 'admin1secret', :password_confirmation => 'admin1secret')
      User.create(:username => 'admin2', :email => 'renata.gerhat@1xferienhaus.de', :password => 'admin2secret', :password_confirmation => 'admin2secret')
      User.create(:username => 'admin3', :email => 'renata.gerhat@1xferienhaus.de', :password => 'admin3secret', :password_confirmation => 'admin3secret')
  ...
  def csv_import
    ...
    if params[:dump].nil?
      ...
      begin
        ...
        house.living_room_sq = line[22]
        # X => Helyiségek alapterülete, nappali + étkező
        house.living_dining_room_sq = line[23]
        # Y => Helyiségek alapterülete, nappali + étkező + konyha
        house.living_dining_kitchen_sq = line[24]
        # Z - AE => Helyiségek alapterülete
        house.kitchen_sq = line[25]
        house.dining_room_sq = line[26]
        house.kitchen_dining_room_sq = line[27]
