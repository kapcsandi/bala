    ...
    module TaggableOn
      ...
      module SingletonMethods
        ...
        def find_options_for_tag_counts(options = {})
          options.assert_valid_keys :start_at, :end_at, :conditions, :at_least, :at_most, :order, :limit, :on, :id, :language
          ...
          if options[:language]
            owner_table = base_class.table_name            
            conditions << sanitize_sql(["#{owner_table}.language = ?", options.delete(:language)])
          end
